...
def evolve_visual(msnake, levelset=None, num_iters=20, background=None):
    ...
    if background is None:
        ...
        ax1.imshow(background, cmap=ppl.cm.gray, interpolation='Nearest')
    ...
    for i in range(num_iters):
        ...
        ax1.contour(msnake.levelset, [0.5], colors='g')
...
# CAHMOD: below code uses mayavi, which does not support Python 3
